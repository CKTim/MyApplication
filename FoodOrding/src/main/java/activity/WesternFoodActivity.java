 ...
 */
public class WesternFoodActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Western_fragment1 f1 = new Western_fragment1();
        Western_fragment2 f2 = new Western_fragment2();
        list.add(f1);
        list.add(f2);
    ...
    private void initIDs() {
        tablayout = (TabLayout) this.findViewById(R.id.western_tablayout);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_back:
                WesternFoodActivity.this.finish();
                break;
            case R.id.btn_openmylove:
                Intent intent=new Intent(WesternFoodActivity.this,MyLoveActivity.class);
